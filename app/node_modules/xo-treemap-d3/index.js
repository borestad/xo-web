  ...
  .directive('treemapChart', function ($parse) {
    function link (scope, element, attrs) {
      ...
      if (attrs.width) {
        ...
        $e = $(element[0])
        while (!$e.innerWidth() && ($parent = $e.parent())) {
          $e = $parent;
        }
        width = $e.innerWidth() || 300
      }
      ...
      div = d3
        ...
        .style({
          position': 'relative',
          // TODO: The appended 'px' can probably be removed as an integer is an implicit px value
      ...
      scope.$watch(() => scope.chartData, function (newVal) {
        ...
        g.enter()
          ...
          .call(position)
          .style('background', function (d) { return d.color || d.children ? color(d.name) : null })
      ...
      function mouseover (d) {
        ...
        if (scope.over) {
          scope.over.call(null, { d: d })
        }
      }

      function click (d) {
        if (scope.click) {
          scope.click.call(null, { d: d })
        }
      }
      function position () {
      ...
      function updateBreadcrumbs (nodeArray, percentageString) {
        ...
        var $e = $('.breadcrumbs-container', element[0])
        var $parent;
        var width;
        
        while ( (width = $e.width()) === 0 && ($parent = $e.parent()) ) {
          $e = $parent;
        }
        if (width) {
          b.w = (width - b.t) / max_depth - b.s
        }
